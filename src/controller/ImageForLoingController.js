...
module.exports = {
    AddImage: async (req, res) => {
        try {
            ...
            let data=await model.Update_If_Available_Else_Insert("asset", "asset", insertData,{}, res)
            if (data) {
                res.send({
                    success: true,
    ...
    //               loginPages: {
    //                 $push: {$concat:[process.env.BASE_URL,"/api/loginPage/","$loginPage"]} // Accumulates all loginPage values into an array
    //               }
    //             }
    //           },
    //           {
