// function getCommaSeparatedValuesFromNestedKeys(data, nestedKey) {
//     if (!Array.isArray(data)) {
//         return ""; // Return an empty string if the input is not an array
//     }

//     if (!nestedKey) {
//         return ""; // Return an empty string if the key is not provided
//     }
...
//     }
//     else{
//         console.log("recurtion",keys.slice(1).join("."));
...
const nestedKey = "tblState.tblCity.name"; // Specify the nested key in dot notation here
  const commaSeparatedValues = getCommaSeparatedValuesCountFromNestedKeys(dataArray, nestedKey);
// const commaSeparatedValues = ProccessForTheCommaSeperated(Data, nestedKey);
// const commaSeparatedValues = getCommaSeparatedValuesByNestedKey(Data, nestedKey);
console.log(commaSeparatedValues); // Output: "Tel Aviv, Jerusalem, New York, Los Angeles, Mumbai, Delhi, Toronto, Vancouver"
